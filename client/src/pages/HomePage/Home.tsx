...
const HomePage: React.FC<Props> = () => {
    ...
    const pageName = <h2><span>Home</span></h2>;
    const rightButton = <IconButton Icon={Flare} iconSize="md" color="var(--twitter-blue)" />;
    return (
        <>
            <TopBar firstElement={avatar} secondElement={pageName} thirdElement={rightButton} />
